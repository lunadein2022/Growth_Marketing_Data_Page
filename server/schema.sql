-- Archived alternative: PostgreSQL schema draft.
-- Current selected backend is Firebase/Cloud Firestore, not Supabase/PostgreSQL.
-- Keep this file only as a relational-model reference.
