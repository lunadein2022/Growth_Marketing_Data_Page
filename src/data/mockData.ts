...
export const channels: ChannelView[] = [
  ...
  },
  {
    ...
    tabs: ["전체", "KR", "EN", "검색"],
    kpis: [
      { label: "사용자", value: "N/A", delta: "동기화 대기", status: "not_uploaded" },
    ...
    trend: [],
    topContent: [],
    dataNote: "GA4 + Search Console 동기화 후 국문/영문 실데이터가 표시됩니다.",
  },
  {
    id: "linkedin",
    name: "LinkedIn",
    ...
    tabs: ["전체", "게시물", "팔로워"],
    kpis: [
      { label: "노출", value: "N/A", delta: "업로드 대기", status: "not_uploaded" },
      { label: "클릭", value: "N/A", delta: "업로드 대기", status: "not_uploaded" },
      { label: "참여율", value: "N/A", delta: "업로드 대기", status: "not_uploaded" },
      { label: "신규 팔로워", value: "N/A", delta: "업로드 대기", status: "not_uploaded" },
      { label: "방문자", value: "N/A", delta: "업로드 대기", status: "not_uploaded" },
    ],
    trend: [],
    topContent: [],
    dataNote: "LinkedIn 분석 파일(content/followers/visitors)을 업로드하면 실데이터가 표시됩니다.",
  },
  {
    id: "naver",
    name: "Naver Blog",
...
export const dataCenterSnapshot: DataCenterSnapshot = {
  sources: DATA_CONNECTION_SOURCES,
  mappingRows: DATA_CONNECTION_MAPPING_ROWS,
  issues: DATA_CONNECTION_ISSUES,
};
